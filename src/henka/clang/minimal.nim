...
proc clang_isConstQualifiedType*(typ: CXType): cuint {.importc, dynlib: libclang, cdecl.}
proc clang_getTypeDeclaration*(typ: CXType): CXCursor {.importc, dynlib: libclang, cdecl.}
